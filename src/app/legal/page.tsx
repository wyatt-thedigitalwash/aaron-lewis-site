...
export const metadata: Metadata = {
  ...
  description:
    "Terms and policies for the Aaron Lewis official website, operated by Borchetta Entertainment Group, LLC and its affiliates.",
  alternates: { canonical: "https://aaronlewismusic.com/legal" },
